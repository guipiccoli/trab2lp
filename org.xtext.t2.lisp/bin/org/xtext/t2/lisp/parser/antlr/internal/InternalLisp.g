...
entryRuleOperacoes returns [String current=null]:
	{ newCompositeNode(grammarAccess.getOperacoesRule()); }
	iv_ruleOperacoes=ruleOperacoes
	{ $current=$iv_ruleOperacoes.current.getText(); }
	EOF;

// Rule Operacoes
ruleOperacoes returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
