...
public class LispParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LispGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getNumerosAssignment_0(), "rule__Model__NumerosAssignment_0");
			builder.put(grammarAccess.getModelAccess().getBeginAssignment_1(), "rule__Model__BeginAssignment_1");
			builder.put(grammarAccess.getModelAccess().getExpressionAssignment_2(), "rule__Model__ExpressionAssignment_2");
			...
			builder.put(grammarAccess.getDefineAccess().getCommandAssignment_2(), "rule__Define__CommandAssignment_2");
			builder.put(grammarAccess.getExpressionAccess().getOperacoesAssignment_1(), "rule__Expression__OperacoesAssignment_1");
			builder.put(grammarAccess.getExpressionAccess().getPrimeiroAssignment_2(), "rule__Expression__PrimeiroAssignment_2");
